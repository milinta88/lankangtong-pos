  ...
  return (
    <main className="min-h-screen bg-[#f5efe6] text-stone-950 lg:grid lg:grid-cols-[240px_minmax(0,1fr)]">
      <aside className="hidden border-r border-[#e5d7c7] bg-white/90 px-4 py-5 shadow-sm lg:block">
        <div className="rounded-2xl bg-[#f6efe7] p-4 text-center shadow-sm ring-1 ring-[#ead9c7]">
          <BrandLogo className="mx-auto h-28 w-28 p-2 shadow-sm ring-1 ring-[#ead9c7]" />
          <p className="mt-3 text-xs font-black uppercase tracking-[0.18em] text-[#8a6a4f]">Langangtong</p>
          ...
          <div className="mx-auto flex max-w-[1680px] flex-col gap-4 px-4 py-4 md:px-6">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex items-center gap-3">
                <BrandLogo className="h-10 w-10 shrink-0 p-1.5 shadow-sm ring-1 ring-[#ead9c7]" />
                <div>
